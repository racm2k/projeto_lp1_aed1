...
/*
     ...
     inserir_cliente_cabeca(4, "Alfredo", "tua tia", 15150, 4343, 4, 6, 2001, 3, 4, 2005);
     inserir_cliente_cauda(20, "Baguetes", "homeless part2", 10101, 666, 6, 8, 2000, 1, 2, 2001);
     inserir_cliente_cabeca(17, "Joaquim", "tua prima", 69690, 4204, 8, 10, 1998, 5, 6, 1999);
...
//     imprimir_viagens_cliente(6968);
    ...
    //   inserir_cidade_lista_global(1,"Braga", "uma merda", 254.13f, 153.6f);
    // inserir_cidade_lista_global(1,"Porto", "Porto ", 534.24f, 765.42f);
...
//     pesquisar_PoI("Porto","Estadio do Dragao");
    ...
    ler_clientes_ficheiro_txt_formatado(
            "C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\clientes_viagens_formatado.txt");
//    escrever_clientes_ficheiro_txt_formatado("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\clientes_viagens_formatado.txt");
//    escrever_clientes_viagens_bin("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\clientes_viagens_bin.bin");
//    ler_clientes_viagens_ficheiro_bin("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\clientes_viagens_bin.bin");
//    imprimir_clientes();
    ler_cidade_ficheiro_txt("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\cidades_pois.txt");
//    escrever_cidades_ficheiro_txt("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\cidades_pois.txt");
//    printf("num cidades: %d",lcidades->num_cidades);
//    escrever_cidades_pois_bin("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\cidades_pois_bin.bin");
//    ler_cidades_pois_ficheiro_bin("C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\cidades_pois_bin.bin");
//    printf("num cidades: %d",lcidades->num_cidades);
...
//    gerar_relatorio_viagens_cliente_betweenDates(6968, dataMin, dataMax,"C:\\Users\\ruben\\Documents\\projeto_lp1_aed1\\data\\relatorio_viagens_cliente.txt");
